...
/**
 * Render a complete static HTML document for the icons demo using the provided view props.
 *
 * @param props - Configuration for the demo, including the list of icon identifiers to render.
 * @returns A complete HTML document string starting with `<!DOCTYPE html>` that contains the server-rendered icons demo.
 */
